  ...
  <SelectPrimitive.Trigger
    ...
    className={cn(
      `border-input  bg-charcoal-900 ring-offset-background
          placeholder:text-charcoal-300 focus-visible:ring-ring flex w-full justify-between items-center
...
export {
  Select, SelectContent, SelectGroup, SelectItem, SelectLabel, SelectNew, SelectScrollDownButton, SelectScrollUpButton, SelectSeparator, SelectTrigger, SelectValue
};
