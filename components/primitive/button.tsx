...
const buttonVariants = cva(
  ...
  focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50`,
  {
    variants: {
      variant: {
        default:
          "bg-gossamer-500 disabled:pointer-events-auto disabled:cursor-not-allowed enabled:hover:bg-gossamer-400 enabled:hover:text-gossamer-950",
        destructive:
      ...
      size: {
        default: "min-h-10 px-4 py-3 lg:text-lg",
        sm: "rounded-md text-sm px-4 py-2 lg:text-base",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
